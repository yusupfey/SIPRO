<div class="container bg-white" style="font-family:Cambria, Cochin, Georgia, Times, 'Times New Roman', serif">
    <div class="row">
        <div class="col-md-8 pt-4 pl-4 pr-4 pb-4">
            <div class="row">
                <div class="col-md-12 text-center">
                    <img class="img-thumbnail" src="<?= base_url() ?>pic/default.jpg" style="width:100%;height:400px" alt=" Card image cap">
                </div>
